                    ...
                    child: Stack(children: [
                            ...
                            IconButton(
                              onPressed: () {
                                ...
                                controller.setPlaybackSpeed(
                                    controller.value.playbackSpeed - 0.25);
                              },
                              icon: Icon(
                                Icons.fast_rewind,
                                color: Colors.grey,
                      ...
                      IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: controller.value.volume == 0.0 ? Colors.red : Colors.grey,
                          size: 22,
                        ),
                      ),
                ...
                Padding(
                  ...
                  child: Align(
                    child: Container(
                      ...
                      child: Text(
                        "الفيزياء الحديثة و نظرية العلماء فى تطور المركب ",
                        style: TextStyle(
                          fontFamily: 'Cairo',
                          color: Colors.black,
                          fontSize: 21.89,
